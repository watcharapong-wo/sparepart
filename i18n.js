const translations = {
  en: {
    ...
    date: "Date",
    part: "Search Part",
    searchParts: "Search by Part No or Name...",
  ...
  th: {
    ...
    newPartNo: "รหัสประเภทอะไหล่ใหม่",
    ...
    trackSerials: "ต้องระบุเลข SP no รายชิ้นทุกครั้ง",
    serialNumbers: "รายการเลข SP no (บรรทัดละ 1 เลข)",
    selectSerials: "เลือกเลข SP no ที่ต้องการเบิก",
    selectedSerials: "เลข SP no ที่เลือกไว้"
  }
};
